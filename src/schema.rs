...
impl SchemaRegistry {
    /// Create a new schema registry with core User schema loaded.
    pub fn new() -> Self {
        let core_user_schema = Self::load_core_user_schema();
    ...
    /// Load the hardcoded core User schema as defined in RFC 7643.
    fn load_core_user_schema() -> Schema {
        Schema {
            ...
            attributes: vec![
                ...
                // name - complex attribute for structured name
                AttributeDefinition {
                    name: "name".to_string(),
                ...
                // phoneNumbers - multi-valued complex attribute
                AttributeDefinition {
                ...
                // meta - complex attribute for metadata
                AttributeDefinition {
                    name: "meta".to_string(),
                    data_type: AttributeType::Complex,
                    required: false,
